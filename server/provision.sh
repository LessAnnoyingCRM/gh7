...
sudo apt-get update
sudo apt-get install -y emacs git mysql-client nginx php7.0-fpm php7.0-mysql php7.0-mbstring php7.0-mcrypt php7.0-curl php7.0-zip php7.0-bcmath php7.0-xml s3cmd awscli ssl-cert
